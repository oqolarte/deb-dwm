...
static const char selbordercolor[]  = "#722f37";
static const char selbgcolor[]      = "#722f37";
...
static const char *cmdsoundup[]  = { "amixer", "-q", "sset", "Master", "3%+", NULL };
static const char *cmdsounddown[]  = { "amixer", "-q", "sset", "Master", "3%-", NULL };
...
static const char *webbrowser2[] = {"tabbed", "-c", "surf", "-e", NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		        XK_w,	    spawn,	   {.v = webbrowser2} },
	{ MODKEY,			            XK_s,	   spawn,	   {.v = messenger} },
    { MODKEY|ShiftMask,             XK_m,       spawn,          {.v = emailclient} },
	{ 0,                            XK_Print,  spawn,          {.v = screenshot } },
 	{ MODKEY,                       XK_F2,     spawn,          {.v = cmdlock } },
